...
//							alert(resp.errors[0].message);
			...
			colModel:[
				...
				{name:'nickName',index:'nickName',sortable:false,  width:80,editable: true,editoptions:{size:"20",maxlength:"50"}, formatter:'showlink', formatoptions:{baseLinkUrl:'userList.html', addParam: '&action=edit', idName:'uid'}},
			...
			//multikey: "ctrlKey",
			multiboxonly: true,
			editurl: "/userList.json",//nothing is saved
			caption: "用户列表"
			,autowidth: true,
			sortname: 'uid',
			sortorder: 'desc',
