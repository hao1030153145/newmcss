/**
 * @project: with 
 * @Title: ScaleImageUtils.java 
 * @Package: com.transing.mcss.util.image
 *
 ...
 * @author TODO
 * @version 1.0 2015-3-18 下午01:50:22
 */
public abstract class ScaleImageUtils {
    ...
    private static final String DEFAULT_FILE_PATH = "d:/log/temp-";

    /**
     * <b>function:</b> 设置图片压缩质量枚举类； Some guidelines: 0.75 high quality、0.5 medium quality、0.25 low quality
     * 
     * @author lance
     * @createDate 2015-03-18 上午11:31:45
     * @file ScaleImageUtils.java
     * @package com.hoo.util
     * @project JQueryMobile
     * @blog http://blog.csdn.net/IBM_lance
     * @email lance_@126.com
     * @version 1.0
     */
     ...
     * 
     * @author lance
     * @createDate 2015-2-6 下午04:41:48
     ...
     * 
     * @author lance
     * @createDate 2015-03-18 上午11:01:27
     * @param width 缩放的宽度
     * @param height 缩放的高度
     * @param quality 图片压缩质量，最大值是1； 使用枚举值：{@link ImageQuality} Some guidelines: 0.75 high quality、0.5 medium quality、0.25 low quality
     * @param savePath 保存目录
     * @param targetImage 即将缩放的目标图片
     * @return 图片保存路径、名称
     * @throws ImageFormatException
     ...
     * 
     * @author lance
     * @createDate 2015-2-6 下午05:53:10
     * @param width 指定的宽度
     * @param height 指定的高度
     * @param image 图片文件
     ...
     * 
     * @author lance
     * @createDate 2015-03-18 上午10:27:59
     * @param scale 缩放比例
     * @param image 图片对象
     * @return 返回宽度、高度
     */
     ...
     * 
     * @author lance
     * @createDate 2015-2-6 下午04:57:02
     * @param width 缩小的宽度
     * @param height 缩小的高度
     * @param savePath 保存目录
     ...
     * 
     * @author lance
     * @createDate 2015-2-6 下午04:57:07
     * @param width 缩小的宽度
     * @param height 缩小的高度
     * @param savePath 保存目录
     * @param targetImage 改变的目标图片
     ...
     * 
     * @author lance
     * @createDate 2015-03-18 上午10:29:18
     * @param scale 缩放比例
     ...
     * 
     * @author lance
     * @createDate 2015-03-18 上午10:30:56
     * @param scale 缩放比例
     * @param savePath 保存文件路径、名称
     * @param targetFile 本地图片文件
     * @return 新的文件名称
     ...
     * 
     * @author lance
     * @createDate 2015-03-18 上午10:49:56
     * @param width 固定宽度
     ...
     * 
     * @author lance
     * @createDate 2015-03-18 上午10:50:52
     * @param width 固定宽度
     * @param savePath 保存路径、名称
     * @param targetFile 本地目标文件
     * @return 返回保存路径
     ...
     * 
     * @author lance
     * @createDate 2015-03-18 上午10:51:17
     * @param height 固定高度
     * @param savePath 保存路径、名称
     * @param targetFile 本地目标文件
     * @return 返回保存路径
     ...
     * 
     * @author lance
     * @createDate 2015-03-18 上午10:52:23
     * @param height 固定高度
     * @param savePath 保存路径、名称
     * @param targetFile 本地目标文件
     * @return 返回保存路径
     ...
     * 
     * @author lance
     * @createDate 2015-2-3 上午10:08:47
     * @param args
     * @throws IOException
    ...
    public static void main(String[] args) throws ImageFormatException, MalformedURLException, IOException {
        ...
        System.out.println(ScaleImageUtils.resize(1242, 1242, null, new URL("http://wx.qlogo.cn/mmopen/ofvnGicEPbfQtWnmAgxvL9OuibJsblEzqzzJRmHC2VKQcKcgeJhVZe9g3qKocxIPibOHYaTicYs1QlgVBRrD5dpzaQ/0")));
        System.out.println(ScaleImageUtils.resize(640, 640, null, new URL("http://wx.qlogo.cn/mmopen/ofvnGicEPbfQtWnmAgxvL9OuibJsblEzqzzJRmHC2VKQcKcgeJhVZe9g3qKocxIPibOHYaTicYs1QlgVBRrD5dpzaQ/0")));
        System.out.println(ScaleImageUtils.resize(640, 640, null, new URL("http://wx.qlogo.cn/mmopen/ofvnGicEPbfQtWnmAgxvL9OuibJsblEzqzzJRmHC2VKQcKcgeJhVZe9g3qKocxIPibOHYaTicYs1QlgVBRrD5dpzaQ/0")));
        System.out.println(ScaleImageUtils.resize(640, 640, null, new URL("http://wx.qlogo.cn/mmopen/ofvnGicEPbfQtWnmAgxvL9OuibJsblEzqzzJRmHC2VKQcKcgeJhVZe9g3qKocxIPibOHYaTicYs1QlgVBRrD5dpzaQ/0")));
        System.out.println(ScaleImageUtils.resize(640, 640, null, new URL("http://wx.qlogo.cn/mmopen/ofvnGicEPbfQtWnmAgxvL9OuibJsblEzqzzJRmHC2VKQcKcgeJhVZe9g3qKocxIPibOHYaTicYs1QlgVBRrD5dpzaQ/0")));
    }
